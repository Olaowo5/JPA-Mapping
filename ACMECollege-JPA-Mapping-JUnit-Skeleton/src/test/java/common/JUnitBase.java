...
public class JUnitBase {
	...
	protected static void deleteAllData() {
		...
		deleteAllFrom(Professor.class, em); //1
		deleteAllFrom(Course.class, em); //2
		deleteAllFrom(MembershipCard.class, em); //3
		//deleteAllFrom(DurationAndStatus.class, em);//4
		deleteAllFrom(ClubMembership.class, em);//5
		//deleteAllFrom(CourseRegistrationPK.class, em);//6
		deleteAllFrom(CourseRegistration.class, em); //7
		deleteAllFrom(AcademicStudentClub.class, em);//8
		deleteAllFrom(StudentClub.class, em); //9
		deleteAllFrom(Student.class, em); //10
		deleteAllFrom(NonAcademicStudentClub.class,em); //11
